...
//       expect(Thing.$meta.fields[Thing.$id]!.nullable,isFalse);
//       expect(thing.$classMeta.fields[Thing.$id]!.type,equals(int));
//
//       expect(Thing.$meta.idName,equals('id'));
//       expect(Thing.$meta.idType,equals(int));
//
//       expect(Thing.$meta.fields[Thing.$name]!.nullable,isTrue);
//       expect(Thing.$meta.fields[Thing.$name]!.type,equals(String));
//
//     });
//
//
